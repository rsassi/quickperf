...
public class NewJvmTestLauncher {
    ...
    //The new process must inherit environment variables: should be managed by the OS
    //The new process must inherit properties : TODO:: to be fixed to enhance flexibility
